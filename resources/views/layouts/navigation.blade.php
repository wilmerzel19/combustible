            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        Panel de control @svg('gmdi-settings-suggest-tt', 'w-6 h-6 text-gray-500 fill-current')
                    </x-nav-link>


                    <x-nav-link :href="route('personas.index')" :active="request()->routeIs('personas.index')">
                        Personas @svg('gmdi-person-add-r', 'w-6 h-6 text-gray-500 fill-current')
                    </x-nav-link>


                    <x-nav-link :href="route('tarjetas.index')" :active="request()->routeIs('tarjetas.index')">
                        Tarjetas @svg('gmdi-payment-o', 'w-6 h-6 text-gray-500 fill-current')
                    </x-nav-link>


                    <x-nav-link :href="route('unidades.index')" :active="request()->routeIs('unidades.index')">
                        Unidades @svg('gmdi-electric-car-s', 'w-6 h-6 text-gray-500 fill-current')
                    </x-nav-link>
